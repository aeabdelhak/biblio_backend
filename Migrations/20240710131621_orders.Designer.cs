...
namespace BiblioPfe.Migrations
{
    ...
    [Migration("20240710131621_orders")]
            ...
            modelBuilder.Entity("BiblioPfe.Infrastructure.Entities.Rules", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 10, 14, 16, 19, 843, DateTimeKind.Local).AddTicks(7650),
                            Currency = 0,
                            OnOutOfStock = 2,
                            ShippingFees = 0m,
                            WarrantyDays = 0
            ...
            modelBuilder.Entity("BiblioPfe.Infrastructure.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("6a2c6822-3718-4171-ba19-3d15ac2fd266"),
                            CreatedAt = new DateTime(2024, 7, 10, 14, 16, 19, 843, DateTimeKind.Local).AddTicks(7070),
                            DisplayName = "Aitelhad Abdelhak",
                            Email = "root@bibliolik.com",
                            FirstName = "Abdelhak",
                            IsActive = true,
                            LastName = "Ait Elhad",
                            PasswordHash = "DBC02E7BCB99B54FA2C55B239B93E9BAA3D900536ABD21D05668CD2C7B436C68E31EB503EF7AA2D1108F20F303591C845642F611161F920F46D54CD843A67D0C",
                            PasswordSalt = new byte[] { 6, 2, 131, 71, 169, 58, 86, 165, 210, 44, 47, 46, 32, 230, 141, 25, 209, 4, 189, 219, 83, 187, 167, 127, 186, 80, 155, 206, 92, 20, 176, 113, 31, 250, 106, 170, 232, 88, 141, 222, 61, 158, 109, 206, 138, 67, 35, 65, 41, 150, 143, 58, 198, 65, 123, 70, 150, 69, 168, 31, 216, 63, 133, 172 },
                            Role = 0
                        });
                });
