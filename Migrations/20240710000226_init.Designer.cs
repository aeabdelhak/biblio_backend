            ...
            modelBuilder.Entity("BiblioPfe.Infrastructure.Entities.Rules", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 10, 1, 2, 25, 25, DateTimeKind.Local).AddTicks(3170),
                            Currency = 0,
                            OnOutOfStock = 2,
                            ShippingFees = 0m,
                            WarrantyDays = 0
            ...
            modelBuilder.Entity("BiblioPfe.Infrastructure.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("6a2c6822-3718-4171-ba19-3d15ac2fd266"),
                            CreatedAt = new DateTime(2024, 7, 10, 1, 2, 25, 25, DateTimeKind.Local).AddTicks(2730),
                            DisplayName = "Aitelhad Abdelhak",
                            Email = "root@bibliolik.com",
                            FirstName = "Abdelhak",
                            IsActive = true,
                            LastName = "Ait Elhad",
                            PasswordHash = "F485C3E93D02E7DCA6DC3A8F234D668CF568B755399CEC551749F597B8A6C5D8B4F0E9270D3A9D343062FA973968AB8C3C69637A958B054BA9A0C33BA9C06E74",
                            PasswordSalt = new byte[] { 54, 169, 40, 207, 189, 220, 161, 93, 218, 142, 34, 32, 127, 115, 229, 8, 214, 32, 132, 68, 85, 19, 176, 62, 160, 174, 28, 6, 224, 86, 93, 69, 136, 2, 202, 254, 220, 208, 140, 159, 177, 3, 220, 210, 30, 89, 31, 208, 77, 222, 167, 169, 105, 115, 149, 177, 208, 242, 165, 246, 197, 89, 136, 6 },
                            Role = 0
                        });
                });
